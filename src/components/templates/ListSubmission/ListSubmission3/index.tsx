  ...
  return (
    <div className="flex items-center">
      <div className="w-[50%] bg-[url('$Submission3Image$')] bg-cover bg-no-repeat p-[25px] sm:p-[40px] md:py-[77px] md:px-[75px] rounded-se-[100px] sm:rounded-se-[150px]">
        <p className="text-center text-[#202124] text-[19px] sm:text-[30px] md:text-[40px] not-italic font-[600] leading-[30px] sm:leading-[50px] md:leading-[60px]">
          $Submission3Text$
        </p>
      </div>
      <div className="w-[50%] text-center">
        <h3 className="text-[22px] sm:text-[28px] font-[600] leading-[36px] my-[10px] sm:my-[24px]">
          $Submission3Title$
        </h3>
        <button className="text-[#ffffff] text-[15px] md:text-[20px] font-[600] leading-[24px] flex items-center bg-[#E09B3D] py-[5px] sm:py-[10px] md:py-[15px] px-[20px] sm:px-[40px] md:px-[80px] rounded-[50px] m-[auto] hover:bg-[#C08534] transition duration-[0.3s] ease-in-out">
          $Submission3Connect$
