...
const Layout = () => {
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      <img className="w-[100%] lg:w-[50%] h-[300px] sm:h-[auto] object-cover" src="$Studies3Image$" alt="Studies" />

      <div className="max-w-[100%] lg:max-w-[50%] bg-[#01018C] p-[60px]">
        <h3 className="w-[60%] sm:w-[90%] text-[#ffffff] text-[15px] sm:text-[40px] not-italic font-[600] leading-[60px] border-[#ffffff] border-[2px] rounded-t-[10px] sm:rounded-t-[50px] text-center m-[auto] p-[0] sm:p-[10px] border-b-[0px]">
