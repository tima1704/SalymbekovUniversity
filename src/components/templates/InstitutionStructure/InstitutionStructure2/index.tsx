...
const COUNCILS: IStructure[] = [
  {
    ...
    style: "flex items-center justify-center text-center text-[#000000] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#B5B7C0] border-solid rounded-[16px] w-[350px] sm:w-[500px] lg:max-w-[372px] w-[100%] h-[82px] px-[16px] py-[30px] mt-[30px] lg:my-[75px]"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    style: "flex items-center justify-center text-center text-[#ffffff] text-[18px] not-italic font-[500] leading-[23px] rounded-[16px] bg-[#13529F] py-[30px] w-[350px] sm:w-[500px] mt-[30px] lg:max-w-[372px] w-[100%] h-[82px] px-[16px]"
  },
  {
    id: 5,
    description: "$Councils2List5$",
    style: "flex items-center justify-center text-center text-[#000000] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#B5B7C0] border-solid rounded-[16px] w-[350px] sm:w-[500px] lg:max-w-[372px] w-[100%] h-[82px] px-[16px] py-[30px] mt-[30px] lg:my-[80px]"
  },
  {
    id: 6,
...
const EDUCATIONAL: IStructure[] = [
  {
    ...
    style: "flex items-center justify-center text-center text-[#000000] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#B5B7C0] border-solid rounded-[16px] w-[350px] sm:w-[500px] lg:max-w-[310px] w-[100%] p-[18px] mt-[30px] lg:my-[75px]"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    style: "bg-[#0870AA] flex items-center justify-center text-center text-[#ffffff] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#0870AA] border-solid rounded-[16px] w-[350px] sm:w-[500px] mt-[30px] lg:max-w-[310px] w-[100%] p-[18px]"
  },
  {
    id: 5,
    description: "$Educational2List5$",
    style: "flex items-center justify-center text-center text-[#000000] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#B5B7C0] border-solid rounded-[16px] w-[350px] sm:w-[500px] lg:max-w-[310px] w-[100%] p-[18px] mt-[30px] lg:my-[80px]"
  },
  {
    id: 6,
...
const BASES: IStructure[] = [
  {
    ...
    style: "flex items-center justify-center text-center text-[#000000] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#B5B7C0] border-solid rounded-[16px] w-[350px] sm:w-[500px] lg:max-w-[372px] w-[100%] h-[82px] p-[20px] mt-[30px] lg:my-[75px]"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    style: "flex items-center justify-center text-center text-[#ffffff] text-[18px] not-italic font-[500] leading-[23px] rounded-[16px] bg-[#13529F] py-[30px] w-[350px] sm:w-[500px] lg:max-w-[372px] w-[100%] mt-[30px] h-[82px] p-[20px] px-[70px]"
  },
  {
    id: 4,
    description: "$Bases2List4$",
    style: "flex items-center justify-center text-center text-[#000000] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#B5B7C0] border-solid rounded-[16px] w-[350px] sm:w-[500px] lg:max-w-[372px] w-[100%] h-[82px] p-[20px] mt-[30px] lg:my-[80px]"
  },
  {
    id: 5,
  ...
  },
  {
    ...
    style: "flex items-center justify-center text-center text-[#000000] text-[18px] not-italic font-[500] leading-[23px] border-[2px] border-[#B5B7C0] border-solid rounded-[16px] w-[350px] sm:w-[500px] lg:max-w-[372px] w-[100%] h-[130px] p-[20px] mt-[30px] lg:my-[80px]"
  },
]
