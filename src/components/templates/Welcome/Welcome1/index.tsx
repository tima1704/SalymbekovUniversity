      ...
      <div className="flex items-start max-w-[90%] w-[100%] m-[auto]">
        <div className="py-[40px] sm:pt-[70px] sm:pb-[50px] md:pb-[100px]">
          ...
          <div className="w-[100%] text-[#010170] font-[600] not-italic flex align-center gap-[20px] sm:gap-[50px]">
            <div>
              <p className="text-[18px] sm:text-[27px] md:text-[36px] leading-[20px] sm:leading-[32px] md:leading-[44px]">$WelcomeYearNum$</p>
              <p className="text-[14px] md:text-[18px] leading-[20px] md:leading-[28px] lowercase">$WelcomeYearOfFoundation$</p>
            </div>
            <div>
              <p className="text-[18px] sm:text-[27px] md:text-[36px] leading-[20px] sm:leading-[32px] md:leading-[44px]">$WelcomeStudentsNum$</p>
              <p className="text-[14px] md:text-[18px] leading-[20px] md:leading-[28px] lowercase">$WelcomeStudents$</p>
            </div>
            <div>
              <p className="text-[18px] sm:text-[27px] md:text-[36px] leading-[20px] sm:leading-[32px] md:leading-[44px]">$WelcomePublicationNum$</p>
