      ...
      <div className="flex items-start max-w-[90%] w-[100%] m-[auto]">
        <div className="py-[40px] sm:pt-[70px] sm:pb-[50px] md:pb-[100px]">
          ...
          <div className="w-[100%] text-[#010170] font-[600] not-italic flex align-center gap-[30px] sm:gap-[50px]">
            <div>
              <p className="text-[20px] sm:text-[27px] md:text-[36px] leading-[32px] md:leading-[44px]">$Welcome3YearNum$</p>
              <p className="text-[14px] md:text-[18px] leading-[20px] md:leading-[28px] lowercase">$Welcome3YearOfFoundation$</p>
            </div>
            <div>
              <p className="text-[20px] sm:text-[27px] md:text-[36px] leading-[32px] md:leading-[44px]">$Welcome3StudentsNum$</p>
              <p className="text-[14px] md:text-[18px] leading-[20px] md:leading-[28px] lowercase">$Welcome3Students$</p>
            </div>
            <div>
              <p className="text-[20px] sm:text-[27px] md:text-[36px] leading-[32px] md:leading-[44px]">$Welcome3PublicationNum$</p>
